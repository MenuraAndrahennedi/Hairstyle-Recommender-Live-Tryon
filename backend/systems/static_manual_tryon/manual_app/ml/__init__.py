...
from manual_app.ml.datasets import (
    ATTRIBUTE_FIELDS,
...
from manual_app.ml.face_to_hair_mapper import (
...
from manual_app.ml.hair_segmentation_model import HairSegmentationUNet, build_segmentation_model
from manual_app.ml.hairstyle_attribute_model import HairstyleAttributeModel, build_attribute_model
from manual_app.ml.khairstyle_translation import (
    FIELD_TRANSLATIONS,
