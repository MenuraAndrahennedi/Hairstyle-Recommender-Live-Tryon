...
from manual_app.core.asset_bank import get_asset_by_id
from manual_app.core.face_analyzer import analyze_face_image
from manual_app.core.hair_segmentation import save_predicted_hair_mask, predict_hair_mask_image
from manual_app.core.tryon_2d_generative_prototype import prepare_generative_tryon_prototype
from manual_app.core.uploads import save_uploaded_image
from manual_app.models.schemas import GenerativeTryOnPrototypeResponse
