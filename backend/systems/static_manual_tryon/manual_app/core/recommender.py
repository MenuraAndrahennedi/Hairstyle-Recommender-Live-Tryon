...
from manual_app.config import FACE_TO_HAIR_MAPPER_CONFIG_PATH, PROJECT_ROOT, media_url_for_path
from manual_app.core.asset_bank import load_asset_bank
from manual_app.ml.face_to_hair_mapper import load_mapper_payload, predict_hair_labels_from_candidates
from manual_app.models.schemas import (
    AssetMetadata,
    FaceAttributes,
    RecommendationItem,
