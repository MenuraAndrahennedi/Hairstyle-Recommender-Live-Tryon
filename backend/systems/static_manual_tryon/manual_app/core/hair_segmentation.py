...
from manual_app.config import PREDICTIONS_DIR, SYSTEM_ROOT
from manual_app.ml.inference import load_segmentation_checkpoint, predict_hair_mask
from manual_app.ml.transforms import ResizeImage
