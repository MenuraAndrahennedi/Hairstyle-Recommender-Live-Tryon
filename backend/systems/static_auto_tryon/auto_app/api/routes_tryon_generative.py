...
from auto_app.config import media_url_for_path
from auto_app.core.asset_bank import get_asset_by_id
from auto_app.core.face_analyzer import analyze_face_image
from auto_app.core.hair_segmentation import save_predicted_hair_mask, predict_hair_mask_image
from auto_app.core.tryon_2d_generative_prototype import prepare_generative_tryon_prototype
from auto_app.core.uploads import save_uploaded_image
from auto_app.models.schemas import GenerativeTryOnPrototypeResponse
